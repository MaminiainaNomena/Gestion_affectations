    ...
    <header class="top-header">
      ...
      <form action="${pageContext.request.contextPath}/employes" method="get" class="search-form">
        <div class="search-wrapper">
          ...
          <button type="submit" class="btn-search" title="Chercher">
      ...
      <a class="btn btn-primary" href="${pageContext.request.contextPath}/employes/new">
      ...
      <main class="main-panel">
        <section class="panel">
          <div class="table-wrap">
            <table class="table-crud employee-table">
              <thead>
                <tr>
                  <th>Code</th>
                  <th>Nom</th>
                  ...
                  <tr>
                    ...
                    <td class="post-cell">
                      ...
                      <span class="row-actions">
                        ...
                        data-tooltip="Modifier l'employé"
                        title="Modifier l'employé"
                        aria-label="Modifier l'employé"
                        href="${pageContext.request.contextPath}/employes/edit?id=${e.codeemp}">
                            <svg class="icon icon-sm" viewBox="0 0 24 24">
